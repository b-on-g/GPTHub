...
declare namespace $ {
	...
	>
	type $mol_text__text_bog_GPTHub_app_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_page__title_bog_GPTHub_app_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__body_bog_GPTHub_app_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
	export class $bog_GPTHub_app extends $mol_book2_catalog {
		...
		plugins( ): readonly(any)[]
		menu_tools( ): readonly(any)[]
		Spread_default( ): ReturnType< $bog_GPTHub_app['Page_main'] >
	}
